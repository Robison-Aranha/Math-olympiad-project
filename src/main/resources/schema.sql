...
create type ITEM_TIPOS as enum("VIDA", "FORCA", "NIVEL", "DESTREZA")
...
create table quest_itens (
    id_quest bigint not null,
    id_item bigint not null
)

alter table quest_itens add constraint foreign key (id_quest) references quest;
alter table quest_itens add constraint foreign key (id_item) references item;
